        ...
        <div class="py-4 overflow-y-auto">
            <ul class="space-y-2">
                ...
                <div class='pt-3 '>
                    ...
                    <a href="{{route('login')}}" class="flex items-center justify-center p-2 text-base font-normal text-gray-900 rounded-lg bg-gray-100 hover:bg-gray-200 text-sm text-dark font-bold rounded-xl transition duration-200 text-center">
                    Sign in
                </a>
                    </li>
                    <li class='pt-3 '>
